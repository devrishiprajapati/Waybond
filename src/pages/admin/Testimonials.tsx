...
export default function AdminTestimonials() {
  ...
  const [pendingDelete, setPendingDelete] = useState<ManagedTestimonial | null>(null)
  ...
  return (
    <div className="min-h-screen bg-white text-white px-4 sm:px-6 md:px-10 lg:px-16 pt-24 md:pt-32 pb-28 lg:pb-20">
      ...
      <ConfirmationToast open={pendingDelete !== null} message={`Delete ${pendingDelete?.name || 'this traveller'}'s testimonial? This cannot be undone.`} confirmLabel="Delete" busy={saving} onCancel={() => setPendingDelete(null)} onConfirm={() => { if (pendingDelete) void handleDelete(pendingDelete) }} />
    </div>
  )
}
