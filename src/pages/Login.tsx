            ...
            >
                <div className="p-5 sm:p-7 md:p-10 rounded-[2rem] sm:rounded-[2.5rem] border border-slate-200 shadow-xl bg-white">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-1">
                            <label className="text-[8px] uppercase font-black text-slate-500 tracking-[0.2em] ml-4">Email</label>
                            <div className="relative">
                        ...
                        <button
                            type="submit"
                            disabled={submitting}
                            className="w-full bg-secondary text-white py-5 rounded-2xl font-black text-[10px] uppercase tracking-[0.3em] shadow-xl shadow-secondary/20 transition-all flex items-center justify-center active:scale-95 touch-manipulation"
                        >
                            {submitting ? 'Please wait' : resetMode ? (otpSent ? 'Reset Password' : 'Send OTP') : (isLogin ? 'Sign In' : 'Join')}
