            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-3 pt-6 border-t border-white/10">
                <Link
                  ...
                  className="bg-white/5 border border-white/10 rounded-2xl p-4 text-center hover:bg-white/10 hover:border-secondary/30 transition-all duration-300 group"
                >
                  <User size={18} className="text-secondary mx-auto mb-2 group-hover:scale-110 transition-transform" />
                  <p className="text-[8px] text-white/35 font-black uppercase tracking-[0.18em]">Profile</p>
                  <p className="text-sm font-black mt-1 text-secondary">View</p>
                </Link>
                <Link
                  to="/wishlist"
                  onClick={() => haptics.light()}
                  className="bg-white/5 border border-white/10 rounded-2xl p-4 text-center hover:bg-white/10 hover:border-secondary/30 transition-all duration-300 group relative"
                >
                  <Heart size={18} className="text-secondary mx-auto mb-2 group-hover:scale-110 transition-transform" />
