...
const UserDashboard = () => {
  ...
  const stats = useMemo(() => {
    ...
    return [
      { label: 'Booked Trips', value: String(bookedTrips.length).padStart(2, '0'), icon: Compass },
      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {stats.map((stat, index) => (
                <motion.div
                  ...
                  className="liquid-glass-dark border border-white/10 p-6 rounded-[2rem] flex items-center gap-5"
                >
                  <div className="w-14 h-14 rounded-2xl bg-secondary/20 border border-secondary/20 flex items-center justify-center text-secondary">
                    <stat.icon size={24} />
                  </div>
                  <div>
                    <p className="text-[9px] font-black text-white/40 uppercase tracking-[0.25em]">{stat.label}</p>
                    <p className="text-3xl font-display font-black text-white leading-none mt-2">{stat.value}</p>
                  </div>
                </motion.div>
              ))}
            </div>
            ...
            <section className="space-y-5">
              <div className="flex items-center justify-between gap-4">
                <h2 className="text-2xl font-display font-black uppercase italic tracking-tight flex items-center">
                  <Calendar className="mr-3 text-secondary" /> Booked Trip Details
                </h2>
                <Link
                  to="/discover"
          ...
          <aside className="xl:col-span-4 space-y-8">
            <section className="liquid-glass-dark border border-white/10 p-8 rounded-[2.5rem] overflow-hidden relative">
