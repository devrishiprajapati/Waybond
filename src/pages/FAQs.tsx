        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.65fr_0.75fr] gap-10 lg:gap-16 items-start">
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-3 w-full bg-secondary text-white px-6 py-4 rounded-full font-black text-[10px] uppercase tracking-[0.22em] hover:bg-secondary/80 transition-all duration-500 shadow-xl shadow-secondary/20 active:scale-95"
            >
