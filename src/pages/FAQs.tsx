      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.65fr_0.75fr] gap-10 lg:gap-16 items-start">
            ...
            {faqs.map((faq, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span className={`font-bungee font-black text-lg md:text-xl uppercase italic tracking-tight transition-colors ${isOpen ? 'text-secondary' : 'text-white'}`}>
                      {faq.question}
                    </span>
          ...
          >
            ...
            <h2 className="text-3xl font-bungee font-black uppercase italic tracking-tighter text-white">Still need a hand?</h2>
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-3 w-full bg-secondary text-white px-6 py-4 rounded-full font-black text-[10px] uppercase tracking-[0.22em] hover:bg-white hover:text-slate-800 transition-all duration-500 shadow-xl shadow-secondary/20 active:scale-95"
            >
