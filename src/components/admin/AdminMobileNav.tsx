...
const navItems = [
  ...
  { label: 'Enquiries', path: '/admin/enquiries', icon: MessageSquare, permission: 'manage_enquiries' },
  ...
  { label: 'Cancels', path: '/admin/cancellations', icon: XCircle, permission: 'view_bookings' },
